        ...
        <div class="iconoder col-5 d-flex">
            <ul class="navbar-nav ms-auto align-items-right flex-row" style="align-items: flex-end;">
                <button class="corazon rounded border border-dark" type="button" data-bs-toggle="modal"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="55" height="60" fill="#ffffff" class="bi bi-heart" viewBox="0 0 16 16">
                ...
                <button class="corazon rounded border border-dark" type="button" data-bs-toggle="modal"
                    data-bs-target="#perfil">
                    <svg xmlns="http://www.w3.org/2000/svg" width="55" height="60" fill="#ffffff" class="bi bi-cart mx-3" viewBox="0 0 16 16">
                ...
                <button class="corazon rounded border border-dark" type="button" data-bs-toggle="modal"
                    ...
                    <img class="tamañoImagenPerfil rounded-circle" src="../../resources/img/iconoPerfil.jpg" alt="" width="55px" height="55">
                    </a>
                    </button>
            </ul>
        </div>
